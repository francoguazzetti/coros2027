  ...
  return (
    <div className="space-y-4 mb-6">
      ...
      <div className="flex justify-between mb-[33px]">
        <div className="flex h-24 w-28 flex-col items-center justify-center border border-border bg-claribi-positive rounded-[5px] transition-all duration-200 hover:shadow-md hover:scale-[1.01] relative group cursor-pointer">
        ...
        <div className="flex h-24 w-28 flex-col items-center justify-center border border-border bg-claribi-neutral rounded-[5px] transition-all duration-200 hover:shadow-md hover:scale-[1.01] relative group cursor-pointer">
        ...
        <div className="flex h-24 w-28 flex-col items-center justify-center border border-border bg-claribi-negative rounded-[5px] transition-all duration-200 hover:shadow-md hover:scale-[1.01] relative group cursor-pointer">
      ...
      <div className="flex h-4 w-full border border-border rounded-[5px] overflow-hidden transition-all duration-200 hover:shadow-md relative group cursor-pointer">
        <div 
          className="h-full bg-claribi-positive transition-all duration-200" 
          style={{ width: `${positivePercent}%` }}
        />
        <div 
          className="h-full bg-claribi-neutral transition-all duration-200" 
          style={{ width: `${neutralPercent}%` }}
        />
        <div 
          className="h-full bg-claribi-negative transition-all duration-200" 
