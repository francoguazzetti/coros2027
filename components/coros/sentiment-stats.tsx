  ...
  return (
    <div className="space-y-4 mb-6">
      ...
      <div className="flex justify-between mb-[33px]">
        <div className="flex h-24 w-28 flex-col items-center justify-center border border-border bg-coros-positive rounded-[5px]">
          <span className="text-xs text-foreground">Positivos</span>
          <span className="text-4xl font-light text-foreground">{positives}</span>
        </div>
        <div className="flex h-24 w-28 flex-col items-center justify-center border border-border bg-coros-neutral rounded-[5px]">
          <span className="text-xs text-foreground">Neutrales</span>
          <span className="text-4xl font-light text-foreground">{neutrals}</span>
        </div>
        <div className="flex h-24 w-28 flex-col items-center justify-center border border-border bg-coros-negative rounded-[5px]">
      ...
      {/* Combined Bar */}
      <div className="flex h-4 w-full border border-border rounded-[5px]">
        <div 
